...
# d_path = "/media/cml/Data1/jsp/GFDL-PI/"
# df = xr.open_dataset(d_path+"sfc_chl_Omon_GFDL-ESM4_piControl_r1i1p1f1_gr_000101-050012.nc")
# print(df)

train_path = '/media/cml/Data1/jsp/GFDL-PI/'
