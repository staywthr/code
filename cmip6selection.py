...
ldmn = 0
model_name_list = ['CESM2','GFDL','UKESM1']
...
for lmen in range(1,67):
    indir = f"/media/cml/Data1/jsp/Cmip6LMEdataSelection/{ldmn}/{lmen}/"
    ...
    outdir = f"/media/cml/Data1/jsp/Cmip6LMEdataSelection1/{ldmn}/{lmen}/"
